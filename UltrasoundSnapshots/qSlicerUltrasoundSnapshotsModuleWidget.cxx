...
::OnClearSnapshotsClicked()
{
  ...
  confirmBox->setText(qSlicerUltrasoundSnapshotsModuleWidget::tr("This action will delete all snapshots."));
  confirmBox->setInformativeText(qSlicerUltrasoundSnapshotsModuleWidget::tr("Continue with this action?"));
