...
{
  return tr("This is a module for reconstructing image volumes from sequences. If you have questions, or encounter an problem, submit an issue on the <a href=\")https://github.com/SlicerIGT/SlicerIGT\tr(">GitHub page</a>.");
}
