...
void qSlicerFiducialRegistrationWizardModuleWidget::setup()
{
  ...
  d->PointMatchingComboBox->addItem(vtkMRMLFiducialRegistrationWizardNode::PointMatchingAsString(vtkMRMLFiducialRegistrationWizardNode::POINT_MATCHING_MANUAL).c_str());
